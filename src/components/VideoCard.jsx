...
const VideoCard = ({ info }) => {
  ...
  return (
    <div className="h-80 w-96 z-10 mx-1 my-3 hover:tranform hover:scale-105 transition-transform">
      <img
        className="rounded-xl p-1 w-full z-10"
      ...
      <div className="grid grid-flow-col pt-3 pl-2">
        <div className="h-9 w-9">
          <img
            className="h-full w-full border rounded-full z-10"
            src={thumbnails.medium.url}
            alt="channel-logo"
          />
        </div>
